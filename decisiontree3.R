...
(length(data[data$ShelveLoc=="Bad" | data$ShelveLoc=="Medium", c("Sales")]))/400
...
(predictedSales=predict(prunetree, newdata=testdata, type='vector')) #use of vector is required here as it is a numeric type
